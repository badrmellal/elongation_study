...
AUDIO = Path(os.environ.get("QURAN_AUDIO", str(ROOT / "audio")))
INDEX = Path(os.environ.get("QURAN_INDEX", str(ROOT / "inputs" / "quran_verses.json")))
SEED = 20270911
...
def main():
    ...
    if args.mode == "manifest":
        parser.error("Use relocate_manifest.py with the frozen manifest; new sampling is outside this reproduction release")
    execute(args)
