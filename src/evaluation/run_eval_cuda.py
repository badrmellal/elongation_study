"""Paper's confirmation pipeline on SERVER-AI (CUDA). The paper's code is imported unchanged; the
...
args = argparse.Namespace(mode="run", manifest=EVAL / "phonation_study" / "confirmation" / "manifest_v2.json",
